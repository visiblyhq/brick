...
const _migrationCommandChecker = TypeChecker.fromRuntime(MigrationCommand);
...
class MigrationGenerator extends Generator {
    ...
    return rawCommands
        .map((object) {
          ...
          if (_createIndexChecker.isExactlyType(object.type!)) {
            ...
            final columns =
                reader.read('columns').listValue.map((o) => o.toStringValue());
            ...
            final columnIndex =
                definitionObject.getField('index')!.toIntValue()!;
            ...
            //Taken from https://github.com/GetDutchie/brick/pull/651/files
          } else if (_migrationCommandChecker
              .isAssignableFromType(object.type!)) {
            return null;
          } else {
  ...
  String? generate(LibraryReader library, BuildStep? buildStep,
    ...
    final output =
        Migration.generate(difference.toMigrationCommands(), version!);
